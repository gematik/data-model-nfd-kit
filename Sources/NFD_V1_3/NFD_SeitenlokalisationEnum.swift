...
public enum NFD_SeitenlokalisationEnum: String {
    case empty = ""
    case L = "L"
    case R = "R"
    case B = "B"
    
    public static let namespacePrefix: String? = "NFD_SeitenlokalisationEnum".components(separatedBy: "_")[0]
    
    static func toString(enumType: NFD_SeitenlokalisationEnum) -> String {
        return enumType.rawValue
    }
    
    static func fromString(enumString: String) -> NFD_SeitenlokalisationEnum {
        guard let param = NFD_SeitenlokalisationEnum(rawValue: enumString) else {
            return .empty
        }
        return param
    }
    
    public static func deserialize(_ infoset: Infoset) -> NFD_SeitenlokalisationEnum {
